      ...
      <div className="grid-flow-col gap-4 mx-auto md:mx-0 md:place-self-center md:justify-self-end">
        <a href="#" target="_blank" className="flex mr-4 opacity-60 hover:opacity-100">
          <svg fill="none" height={24} viewBox={`0 0 28 28`} width={24} xmlns="http://www.w3.org/2000/svg" >
            ...
            <path clipRule="evenodd" d="M14 14C14 17.0376 16.4624 19.5 19.5 19.5C22.5376 19.5 25 17.0376 25 14C25 7.92487 20.0751 3 14 3C7.92487 3 3 7.92487 3 14C3 10.9624 5.46243 8.5 8.5 8.5C11.5376 8.5 14 10.9624 14 14ZM19.5 12.5C18.6716 12.5 18 13.1716 18 14C18 14.8284 18.6716 15.5 19.5 15.5C20.3284 15.5 21 14.8284 21 14C21 13.1716 20.3284 12.5 19.5 12.5Z" fillRule="evenodd" style={{ fill: `rgb(var(--black))` }} />
          </svg>
        </a>
        <a href="https://twitter.com/croncats" target="_blank" className="flex mr-4 text-gray-500 hover:text-gray-600">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 m-auto" fill="currentColor" viewBox="0 0 16 16" stroke="none">
            <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"></path>
          </svg>
        </a>
        <a href="https://discord.gg/GJY7QBsDft" target="_blank" className="flex mr-4 text-gray-500 hover:text-gray-600">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 16 16" stroke="none">
        ...
        <a href="https://t.me/croncat" target="_blank" className="flex text-gray-500 hover:text-gray-600">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 16 16" stroke="none">
