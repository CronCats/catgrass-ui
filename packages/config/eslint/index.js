      ...
      rules: {
        ...
        'import/order': [
          'error',
          {
            ...
            pathGroupsExcludedImportTypes: ['@croncat-ui/**'],
        ...
        'regex/invalid': [
          ...
          [
            {
              regex: '\\@\\/\\.\\.\\/\\.\\.\\/packages',
              replacement: '@croncat-ui',
              message:
                'Import from @croncat-ui/* instead of a relative path (i.e. replace "@/../../packages" with "@croncat-ui").',
            },
            {
              regex: '\\@dao\\-dao\\/ui\\/(components|theme)[^\'"]*',
              replacement: '@croncat-ui/ui',
              message:
                'Import from root @croncat-ui/ui instead of a direct path. Ensure the export has been added to its sibling index.',
            },
            {
              regex: '\\@dao\\-dao\\/state\\/hooks\\/clients[^\'"]*',
              message:
                'Import from root @croncat-ui/state using a grouped export, such as CwCoreHooks, instead of a direct path.',
            },
            {
              regex: '\\@dao\\-dao\\/state\\/recoil\\/selectors[^\'"]*',
              message:
                'Import from root @croncat-ui/state instead of a direct path. If using contract client selectors, use a grouped export, such as CwCoreV0_1_0Selectors.',
            },
            {
