...
export const getChainFromChainId = (chainId: string | undefined, chains: ChainMetadata[]): ChainMetadata | undefined => {
  if (!chainId) return;
...
export const getAccountsForNetwork = (network: ChainMetadata, accounts: Account[]) => {
...
export const appendAccountsToNetworks = (networks: ChainMetadata[], accounts: Account[]) => networks.map(n => {
